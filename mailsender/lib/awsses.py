...
from ..settings import AWSCredentials
...
class AmazonSESService:
    ...
    def __init__(
        ...
        if self._creds is not None:
            self._service = boto3.client('ses',**self._creds.model_dump(mode='json')) 
